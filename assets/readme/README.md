...
- `og-image.svg` — source of `public/static/og-img.png` (1200x630 Open Graph
  image).
...
- `og-img.png` is rasterized from `og-image.svg` with headless Chrome:
  `chrome --headless --screenshot=public/static/og-img.png --window-size=1200,630 og-image.svg`
